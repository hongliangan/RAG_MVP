...
def main():
    ...
    parser.add_argument("--mode", choices=["qa", "kb"], default="qa", 
    ...
    parser.add_argument("--action", choices=["add", "search", "list", "delete", "stats", "clear"], 
                       help="知识库操作")
...
def run_qa_mode(args):
    ...
    if not args.file or not args.question:
        ...
        print("示例: python main.py --mode qa --file data/example.txt --question '请总结文档内容'")
        sys.exit(1)
        ...
        if args.action == "add":
            ...
            if documents:
                ...
                for doc in documents:
                    print(f"  ID: {doc['id']}, 文件: {doc['filename']}, 大小: {doc['file_size']} bytes")
            else:
                print("知识库为空")
